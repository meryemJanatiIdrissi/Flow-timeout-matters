...
echo -n "ProcessingUNSW-NB15 dataset ... "

PCAP_BASE_DIR="/home/janati/Desktop/Meryem/IDS-Datasets/Datasets/unsw/pcaps"
OUTPUT_BASE_DIR="/home/janati/Desktop/Meryem/IDS-Datasets/Datasets/unsw/Zeek"
...
EOL
    ...
    #zeek -C -r "$pcap_file" custom_timeout.zeek  tcp_inactivity_timeout=60mins udp_inactivity_timeout=60mins  icmp_inactivity_timeout=60mins
    
    #zeek -C -r "$pcap_file" custom_timeout.zeek  tcp_inactivity_timeout=1mins udp_inactivity_timeout=1mins  icmp_inactivity_timeout=1mins
