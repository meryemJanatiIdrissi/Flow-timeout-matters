...
PCAP_BASE_DIR="/home/janati/Desktop/Meryem/IDS-Datasets/Datasets/ustc/pcaps"
OUTPUT_BASE_DIR="/home/janati/Desktop/Meryem/IDS-Datasets/Datasets/ustc/Argus"
...
EOL
        ...
        if [[ "$timeout" == "default" ]]; then
            ARGUS_OUTPUT_DIR="$OUTPUT_BASE_DIR/$timeout/$folder/argus"
            FEATURES_OUTPUT_DIR="$OUTPUT_BASE_DIR/$timeout/$folder/features"
        else
            ARGUS_OUTPUT_DIR="$OUTPUT_BASE_DIR/timeout$timeout/$folder/argus"
            FEATURES_OUTPUT_DIR="$OUTPUT_BASE_DIR/timeout$timeout/$folder/features"
        fi
