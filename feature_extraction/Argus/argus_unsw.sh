...
PCAP_BASE_DIR="/home/janati/Desktop/Meryem/IDS-Datasets/Datasets/unsw/pcaps"
OUTPUT_BASE_DIR="/home/janati/Desktop/Meryem/IDS-Datasets/Datasets/unsw/Argus"



echo "Processing Datasets UNSW ... "
...
EOL
        ...
        if [[ "$timeout" == "default" ]]; then
            ARGUS_OUTPUT_DIR="$OUTPUT_BASE_DIR/$folder/$timeout/argus"
            FEATURES_OUTPUT_DIR="$OUTPUT_BASE_DIR/$folder/$timeout/features"
        else
            ARGUS_OUTPUT_DIR="$OUTPUT_BASE_DIR/$folder/timeout$timeout/argus"
            FEATURES_OUTPUT_DIR="$OUTPUT_BASE_DIR/$folder/timeout$timeout/features"
        fi
        ...
        echo "_____________________ Dir ${PCAP_DIR}"
